...
int main(void) {
 ...
 uint32_t tx_payload[TX_WORDS] = { 0xDEADBEEF, 0xCAFEBABE };
    ...
    printf("STM32 #1 (0x336): ricevuti %d/100, corretti %d/100\r\n", tot_336, ok_336);
    printf("STM32 #2 (0x436): ricevuti %d/100, corretti %d/100\r\n", tot_436, ok_436);
    printf("STM32 #3 (0x536): ricevuti %d/100, corretti %d/100\r\n", tot_536, ok_536);
